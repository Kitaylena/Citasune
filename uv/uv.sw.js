...
function errorTemplate(trace, fetchedURL) {
	...
	const script = `
        ...
        uvVersion.textContent = "3.0.0";
        uvBuild.textContent = "Citasune Ultraviolet Build 1.0.0 (hey guys did you know cita is based of kita iyuko but kita is cita so it sounds like sita, and sune is from hatsune miku";
    `;
